...
export const CLUSTER_COLORS_FIXED = {
  9:  [231, 201, 183, 255],  // 1.甘口・フルーティー
  7:  [195, 218, 147, 255],  // 2.若飲みフレッシュ
  5:  [112, 175,  84, 255],  // 3.シャープ・クリア
  6:  [235, 220,  80, 255],  // 4.軽快・まろやか
  10:  [216, 209, 119, 255],  // 5.穏やか・ミディアム
  2:  [164, 137,  66, 255],  // 6.個性派・熟成系
  3:  [196,  73,  75, 255],  // 7.軽い・クリーン
  1:  [113,  77, 126, 255],  // 8.円熟・中ボディ
  4:  [ 41,  23,  47, 255],  // 9.濃厚・フルボディ
  8:  [108,  38,  38, 255],  // 10.骨格・スモーキー
...
export const CLUSTER_META = [
  { id: 9,  name: "1.甘口フルーティー",   hint: "低アルで軽く甘酸っぱく、若々しく爽快なフルーティタイプ" },
  { id: 7,  name: "2.若飲みフレッシュ",     hint: "爽やかなハーブや柑橘の香り。フレッシュですっきり爽快な軽口" },
  { id: 5,  name: "3.シャープ•クリア",     hint: "柑橘の酸味と硬質なキレ。淡色で軽快、透明感のある辛口" },
  { id: 6,  name: "4.軽快•まろやか",       hint: "軽快でミルキーさと柑橘が混ざる、柔らかい飲み心地のまろやか" },
  { id: 10, name: "5.穏やかミディアム",    hint: "まろやかな口当たりで、渋み控えめ。柔らかく果実味が広がる" },
  { id: 2,  name: "6.個性派•熟成系",       hint: "スモークやミネラルの複雑な香り。辛口で引き締まった熟成タイプ" },
  { id: 3,  name: "7.軽い•クリーン",       hint: "香り味わいとも軽やかで控えめ。雑味がなく透明感のあるライト感" },
  { id: 1,  name: "8.円熟•中ボディ",       hint: "厚みと甘やかさが調和する、円熟で柔らかく滑らかなリッチ感" },
  { id: 4,  name: "9.濃厚•フルボディ",     hint: "濃厚な果実味と樽香のコク。力強く飲みごたえのあるフルボディ" },
  { id: 8,  name: "10.骨格スモーキー",     hint: "酸味と骨格が調和し、厚みと熟成感が重なるスモーキーで力強い" },
];
