...
export const CLUSTER_COLORS_FIXED = {
  ...
  12:  [195, 218, 147, 255],  // 4.フルーティーアロマ
  11:  [164, 137, 66, 255],  // 5.スモーキー熟成
  8:  [112, 175, 84, 255],  // 6.フレッシュアロマ
  10:  [148, 218, 199, 255],  // 7.キリッと爽快
  1:  [196, 73, 75, 255],  // 8.まろやか芳醇
  4:  [183, 73, 128, 255],  // 9.コク深リッチ
  6:  [113, 77, 126, 255],  // 10.なめらかリッチ
...
export const CLUSTER_META = [
  { id: 7,  name: "1.甘口フルーティー",   hint: "低アルで甘味が強く、熟した果実や蜂蜜のような風味を楽しめるタイプ" },
  { id: 9,  name: "2.スパイシーアロマ",     hint: "スパイスやハーブを思わせる複雑な香りが広がる、香り豊かなタイプ" },
  { id: 2,  name: "3.華やかフローラル",     hint: "白い花や柑橘を思わせる華やかな香りと、爽やかな酸味が楽しめるタイプ" },
  { id: 12,  name: "4.フルーティーアロマ",       hint: "リンゴや洋梨、バナナを思わせる華やかな果実香が広がる親しみやすいタイプ" },
  { id: 11, name: "5.スモーキー熟成",    hint: "熟成由来の奥深い香りと独特な風味を楽しめる、個性的なタイプ" },
  { id: 8,  name: "6.フレッシュアロマ",       hint: "若葉や青リンゴを思わせるフレッシュな香りが広がる爽快なタイプ" },
  { id: 10,  name: "7.キリッと爽快",       hint: "いきいきとした酸味と軽快な飲み口が特徴の、すっきり爽やかなタイプ" },
  { id: 1,  name: "8.まろやか芳醇",       hint: "やわらかな口当たりと程よいコクを持つ、バランスのよいタイプ" },
  { id: 4,  name: "9.コク深リッチ",     hint: "華やかな香りと豊かなコクを持つ、飲みごたえのあるタイプ" },
  { id: 6,  name: "10.なめらかリッチ",     hint: "なめらかな口当たりと軽やかさを持つ、透明感のあるタイプ" },
  { id: 5,  name: "11.濃厚フルボディ",   hint: "熟した果実やバニラを思わせる豊かな香りと、厚みのある味わいが特徴のタイプ" },
